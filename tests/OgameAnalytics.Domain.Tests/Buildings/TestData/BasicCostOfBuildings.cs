...
public class BasicCostOfBuildings
{
    ...
    private static Dictionary<HumanBuilding, EconomicUnit> PopulateHumanBuildings()
    {
        Dictionary<HumanBuilding, EconomicUnit> output = new Dictionary<HumanBuilding, EconomicUnit>()
        {
            ...
            { HumanBuilding.ResearchCentre, EconomicUnit.CreateNewMineralUnit(20_000,25_000,10_000)},
            ...
            { HumanBuilding.HighEnergySmelting,EconomicUnit.CreateNewMineralUnit(9_000,6_000,3_000)},
            { HumanBuilding.FoodSilo,EconomicUnit.CreateNewMineralUnit(25_000,13_000,7_000)},
            { HumanBuilding.FusionPoweredProduction,EconomicUnit.CreateNewMineralUnit(50_000,25_000,15_000)},
            { HumanBuilding.Skycraper,EconomicUnit.CreateNewMineralUnit(75_000,20_000,25_000)},
            { HumanBuilding.BiotechLab,EconomicUnit.CreateNewMineralUnit(150_000,30_000,15_000)},
            { HumanBuilding.Metropolis, EconomicUnit.CreateNewMineralUnit(80_000,35_000,60_000)},
            { HumanBuilding.PlanetaryShield,EconomicUnit.CreateNewMineralUnit(250_000,125_000,125_000)}
    ...
    private static Dictionary<FacilitiesBuilding, EconomicUnit> PopulateFacilityBuildings()
    {
        Dictionary<FacilitiesBuilding, EconomicUnit> output = new()
        {
            ...
            { FacilitiesBuilding.Shipyard,EconomicUnit.FromPrimitives(200,0,50,50,0,0)}
        };
    ...
    private static Dictionary<ResourceBuilding, EconomicUnit> PopulateResourceBuildings()
    {
        ...
        {
            { ResourceBuilding.MetalMine,EconomicUnit.CreateNewMineralUnit(60,15,0)},
            { ResourceBuilding.CrystalMine,EconomicUnit.CreateNewMineralUnit(48,24,0)},
            { ResourceBuilding.DeuteriumSynthesiser, EconomicUnit.CreateNewMineralUnit(225,75,0)},
